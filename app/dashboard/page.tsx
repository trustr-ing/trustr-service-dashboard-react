...
export default function DashboardDemoPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        <h2 className="text-3xl font-bold tracking-tight">Trustr discovery demo</h2>
      ...
      <Card>
        <StepHeader
          step={1}
          title="Configure my baseline web of trust"
          description="GrapeRank ranking of your follow graph (6 levels deep), filtered by mutes and reports."
      ...
      <Card className={!semanticReady ? 'opacity-60' : ''}>
        <StepHeader
          step={3}
          title="Rank authors by engagement"
          description="Score the authors of step 2's results by weighted zaps."
